...
@Component({
  selector: 'app-past-division',
  templateUrl: './past-division.component.html',
  styleUrls: ['./past-division.component.css']
})

export class PastDivisionComponent implements OnInit {
  ...
  constructor( private division:DivisionService, private teamService:TeamService ) {
