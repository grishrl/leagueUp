  ...
  ngAfterViewInit(){
    // console.log(this.match);
        ...
        if (indexOf >= 0) {
          ...
          this.embedLink = `https://player.twitch.tv/?channel=${channelID}&parent=localhost&parent=ngs-herokuapp.com&parent=herokuapp.com&parent=nexusgamingseries.org&autoplay=false&muted=true`;
